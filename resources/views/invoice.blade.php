...
<section class="bill">
    <div class="container" style="text-align: left }}">
        <div class="receipt">
            ...
            <div class="mt-3 mb-3">
                <div class="p-2">
                    <img class="d-block m-auto" style="width: 150px;" src="{{ config('app.logo_url') }}"
                    ...
                    <p class="mb-2">
                        <span class="font-weight-bold">{{--{{ __('keywords.tax_no') }}--}}Tax number</span> : <span
                                class="font-weight-bold">310188508400003</span>
                    </p>
            ...
            @if(isset($orderItem) && $orderItem&&$orderItem->properties && $orderItem->properties->count() > 0)
                <div class="card mb-2">
                    <div class="card-header p-2">
